...
class PresetLEDViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(PresetLEDViewModel::class.java)) {
            return PresetLEDViewModel(dataSource,application,uid,bid) as T
        }
